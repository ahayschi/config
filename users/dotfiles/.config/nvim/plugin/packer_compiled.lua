...
_G.packer_plugins = {
  ["ayu-vim"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/ayu-vim",
  ...
  ["oblivion.vim"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/oblivion.vim",
    url = "https://github.com/miguelmota/oblivion.vim"
  },
  ["packer.nvim"] = {
    loaded = true,
  ...
  ["vim-aldmeris"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/vim-aldmeris",
